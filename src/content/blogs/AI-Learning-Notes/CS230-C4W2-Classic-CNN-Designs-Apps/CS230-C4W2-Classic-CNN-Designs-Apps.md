---
title: 'CS230 C4W2: 经典卷积神经网络设计及CNN常见应用'
publishDate: 2026-01-11
updatedDate: 2026-01-11
description: 'CS230 C4W2: 经典卷积神经网络设计及CNN常见应用'
category: tech
tags:
  - cs230
  - cnn
...
之前我们探讨了什么是CNN，CNN的基本架构，但是**设计CNN** 取得最好的效果也非常重要。经典的CNN设计可以给我们提供这种设计的思路，而当我们知道如何设计一个CNN之后，在落实到具体的项目（人脸识别，图像生成，物体识别）时又分别有些独特的地方，下面将会一一进行介绍
...
* 通过**池化层来调整整体的信息量** ，并且比例大概为1/2左右(VGG-16)
* 如何进行**串联** （ResNets）
* 1\*1卷积核以及由此引发的**并联关系** (GoogleNets)
...
使用以上的skip path的方法我们就可以**训练更深的网络** 。
...
综上所述，我们对于设计网络的时候可以考虑对他们进行**transfer training**,即为固定网络的前面若干层，直到最后的几层换成我们自行设计的网络进行训练。而我们自己设计的时候需要考虑** 信息量的传递关系，可以通过inception block以及skip path的途径**来加深我们的网络并提升性能。这些都是可以考虑的方案。
