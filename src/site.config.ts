...
export const theme: ThemeUserConfig = {
  ...
  description: '墙壁的那边,有大海',
  description_en: 'Beyond the walls, there is the sea.',
  ...
  footer: {
    ...
    social: { github: 'https://github.com/wesleyfei1' }
  },
  ...
  personal: {
    ...
    githubUsername: 'wesleyfei1',
    /** Your email address */
    email: 'wesleyfei224@gmail.com',
    /** Your Google Scholar profile URL */
    googleScholar: 'to be added',
    /** Blog start date for statistics */
    blogStartDate: '2026-01-11',
    /** Domain configuration */
    domains: {
      main: 'bauklotze.vercel.app',
      // githubPages: '',
      // cloudflare: '',
      // friendCircle: '',
    },
...
export const integ: IntegrationUserConfig = {
  ...
  quote: {
    ...
    server: 'https://v1.hitokoto.cn/?c=i',
    target: `() => {
    // 这里的 titanQuotes 会被编译进代码里
    const list = ${JSON.stringify(titanQuotes)};
